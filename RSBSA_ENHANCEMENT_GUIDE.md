...
## 🎯 **RSBSA Number Generation**

### **Automatic RSBSA Number Format:**
```
[Region][Province][Municipality][Barangay][Sequence]
  10      43         24           XX      XXXXXX

Example: 10432401000001
- 10 = Region X
- 43 = Misamis Oriental
- 24 = Opol
- 01 = Awang Barangay
...
// RSBSA Number & Card Management
POST   /api/rsbsa/{id}/generate-number    // Generate RSBSA number
...
Route::prefix('rsbsa')->group(function () {
    ...
    Route::post('/{id}/generate-number', [RSBSAController::class, 'generateRSBSANumber']);
...
✅ **Complete DA-compliant data collection**  
✅ **Professional enrollment workflow**  
✅ **Automatic RSBSA number generation**  
✅ **Card management system**  
